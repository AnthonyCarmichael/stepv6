#ifndef ST_VISITORGRID4DSETVALUE_H
#define ST_VISITORGRID4DSETVALUE_H
...
template< class DataT >
class ST_VisitorGrid4DSetValue : public ST_AbstractVisitorGrid4D<DataT>
{
...
public:
    /*!
     * \brief ST_VisitorGrid4DSetValue
     *
     * Constructeur
     *
     * \param grid : grille que le visiteur viste
     */
    ST_VisitorGrid4DSetValue(HoughSpacePtrConst hough_space_ptr, DataT value_to_set);

    /*!
      * Destructeur (rien a faire, il ne doit pas liberer l'image qu'il visite!!)
      */
    virtual ~ST_VisitorGrid4DSetValue();
...
#include "st_visitorgrid4dsetvalue.hpp"

#endif // ST_VISITORGRID4DSETVALUE_H
